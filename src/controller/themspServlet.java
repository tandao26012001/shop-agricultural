...
/**
 * Servlet implementation class themspServlet
 */
@WebServlet({ "/themspServlet", "/themsp" })
public class themspServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("btthem") !=null) {
			...
			productBL.insertKH(p);
		}
		request.getRequestDispatcher("prServlet").forward(request, response);
	}
	/**
